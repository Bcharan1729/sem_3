...
for a=1:10:251
 ...
 for a=1:26
     for b=1:26
         M1(1,a)=M1(1,a)+M(a,b); % computing marginal histogram
         M2(1,a)=M2(1,a)+M(b,a); 
     end
 end
...
xlabel('Shift (t)');
ylabel('Correlation');
title('3 Correlation vs Shift');
grid on;
saveas(gcf, '3 Correlation_vs_Shift.png');   
...
xlabel('Shift (t)');
ylabel('Quadratic MI');
title('3 Quadratic Mutual Information vs Shift');
grid on;
saveas(gcf, '3 QMI_vs_Shift.png');

figure;
plot(x, MI, 'g-^','LineWidth',1.5);
xlabel('Shift (t)');
ylabel('Mutual Information');
title('3 Mutual Information vs Shift');
grid on;
saveas(gcf, '3 MI_vs_Shift.png');
