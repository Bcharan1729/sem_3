...
xlabel('Shift (t)');
ylabel('Correlation');
title('2 Correlation vs Shift');
grid on;
saveas(gcf, '2 Correlation_vs_Shift.png');   

figure;
plot(x, QMI, 'r-s','LineWidth',1.5);
xlabel('Shift (t)');
ylabel('Quadratic MI');
title('2 Quadratic Mutual Information vs Shift');
grid on;
saveas(gcf, '2 QMI_vs_Shift.png');

figure;
plot(x, MI, 'g-^','LineWidth',1.5);
xlabel('Shift (t)');
ylabel('Mutual Information');
title('2 Mutual Information vs Shift');
grid on;
saveas(gcf, '2 MI_vs_Shift.png');
